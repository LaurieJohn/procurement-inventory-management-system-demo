...
/** One PPMP Project Item, read-only. */
...
/** The office's submission has to still be open for the item to be editable. */
const isLocked = computed(() => {
    if (!item.value) {
        return true
    }

    const status = store.fieldOfficeStatus(ppmpId.value, item.value.fieldoffice_id)?.status_id
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center card-footer bg-transparent mt-5">
                                ...
                                <NuxtLink
                                    v-if="!isLocked"
                                    :to="`/PIMS/PPMP/${plan.id}/items/${item.id}/edit`"
