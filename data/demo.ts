...
export const ppmpItems: PpmpItem[] = [
    ...
    // ── Encoded by the two Employees ──────────────────────────────────────
    // A plain Employee encodes for their own unit, so these sit under TSSD
    // (field office 2) split between the ICT and Labor Standards units.
    {
        id: 13, ppmp_id: 1, user_id: 7, fieldoffice_id: 2, unit_id: 4, status: 1,
        title: 'Supply and Delivery of 1-Year Subscription of SIP Trunk',
        category_id: 8, sub_category_id: 27, project_type_id: 1,
        quantity: '1 subscription', quantity_type: 13, amount: 240_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-12', end_date: '2027-01', expected_date: '2027-02',
        source_fund_id: 1, attached_documents: null,
        remarks: 'Replaces the analogue trunk lines at the Regional Office.',
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-08-18 09:05:00', updated_at: '2026-08-18 09:05:00',
    },
    {
        id: 14, ppmp_id: 1, user_id: 7, fieldoffice_id: 2, unit_id: 4, status: 1,
        title: 'Supply and Delivery of 1-Year Contract of Web-Based Text Messaging Suite',
        category_id: 8, sub_category_id: 26, project_type_id: 1,
        quantity: '1 subscription', quantity_type: 13, amount: 180_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2027-01', end_date: '2027-02', expected_date: '2027-03',
        source_fund_id: 1, attached_documents: null,
        remarks: 'Used for advisories to registered establishments.',
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-08-18 09:30:00', updated_at: '2026-08-18 09:30:00',
    },
    {
        id: 15, ppmp_id: 1, user_id: 7, fieldoffice_id: 2, unit_id: 4, status: 4,
        title: 'Repair and Maintenance of Various Office Equipment',
        category_id: 7, sub_category_id: 24, project_type_id: 1,
        quantity: '1 lot', quantity_type: 3, amount: 165_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-12', end_date: '2027-01', expected_date: '2027-02',
        source_fund_id: 1, attached_documents: null,
        remarks: 'Covers printers, scanners and the two plotters.',
        supply_remarks: 'Merged with the ICT maintenance entry to avoid a duplicate contract.',
        budget_remarks: null, supply_modified: 1, budget_modified: null,
        created_at: '2026-08-19 11:20:00', updated_at: '2026-09-02 14:05:00',
    },
    {
        id: 16, ppmp_id: 3, user_id: 7, fieldoffice_id: 2, unit_id: 4, status: 1,
        title: 'Various Semi-Expendable Office Equipment',
        category_id: 11, sub_category_id: 37, project_type_id: 1,
        quantity: '40 units', quantity_type: 4, amount: 320_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-06', end_date: '2026-07', expected_date: '2026-08',
        source_fund_id: 2, attached_documents: null,
        remarks: null,
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-05-26 10:40:00', updated_at: '2026-05-26 10:40:00',
    },
    {
        id: 17, ppmp_id: 1, user_id: 8, fieldoffice_id: 2, unit_id: 6, status: 1,
        title: 'Catering Services (Meals) for Labor Standards Orientation Seminars',
        category_id: 2, sub_category_id: 7, project_type_id: 1,
        quantity: '800 pax', quantity_type: 1, amount: 560_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-12', end_date: '2027-01', expected_date: '2027-03',
        source_fund_id: 1, attached_documents: null,
        remarks: 'Eight batches of roughly 100 participants each.',
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-08-20 08:15:00', updated_at: '2026-08-20 08:15:00',
    },
    {
        id: 18, ppmp_id: 1, user_id: 8, fieldoffice_id: 2, unit_id: 6, status: 1,
        title: 'Printing and Production of Various Advocacy Materials',
        category_id: 6, sub_category_id: 19, project_type_id: 1,
        quantity: '1 lot', quantity_type: 3, amount: 275_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-11', end_date: '2026-12', expected_date: '2027-01',
        source_fund_id: 1, attached_documents: 'https://drive.google.com/file/d/demo-advocacy-layouts',
        remarks: 'Handbooks, primers and posters for the establishment visits.',
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-08-20 08:45:00', updated_at: '2026-08-20 08:45:00',
    },
    {
        id: 19, ppmp_id: 1, user_id: 8, fieldoffice_id: 2, unit_id: 6, status: 5,
        title: 'Postage and Courier Services for CY 2027',
        category_id: 9, sub_category_id: 33, project_type_id: 1,
        quantity: '12 months', quantity_type: 3, amount: 72_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-12', end_date: '2027-01', expected_date: '2027-01',
        source_fund_id: 1, attached_documents: null,
        remarks: 'Service of notices and orders to establishments.',
        supply_remarks: null,
        budget_remarks: 'Trimmed to the CY 2026 actual spend.',
        supply_modified: null, budget_modified: 1,
        created_at: '2026-08-21 13:05:00', updated_at: '2026-09-04 10:30:00',
    },
    {
        id: 20, ppmp_id: 3, user_id: 8, fieldoffice_id: 2, unit_id: 6, status: 1,
        title: 'Publication of Permit and Licensing Notices',
        category_id: 6, sub_category_id: 20, project_type_id: 1,
        quantity: '1 lot', quantity_type: 3, amount: 95_000,
        mode_procurement_id: 2, pre_procurement_status: false,
        start_date: '2026-06', end_date: '2026-07', expected_date: '2026-08',
        source_fund_id: 2, attached_documents: null,
        remarks: null,
        supply_remarks: null, budget_remarks: null, supply_modified: null, budget_modified: null,
        created_at: '2026-05-27 15:25:00', updated_at: '2026-05-27 15:25:00',
    },
]
...
export const procurements: Procurement[] = [
    ...
    {
        id: 7, user_id: 7, disbursement_id: 4,
        request_by: 'ARNEL D. MABINI', approved_by: 'ATTY. RICARDO M. ESTRELLA',
        title: 'Supply and Delivery of Network Switches and Wireless Access Points',
        description: 'Network equipment to extend coverage to the annex and the training hall.',
        procurement_status_id: 5, pr_type_id: 4, mode_of_procurement_id: 1,
        date: '2026-09-02', date_required: null,
        remarks_unit_head: null, remarks_division_fo_head: null, remarks_supply_officer: null,
        remarks_budget_officer: null, remarks_ord: null,
        created_at: '2026-09-02 10:20:00', updated_at: '2026-09-08 16:10:00',
    },
    {
        id: 8, user_id: 7, disbursement_id: 4,
        request_by: 'ARNEL D. MABINI', approved_by: 'ATTY. RICARDO M. ESTRELLA',
        title: 'Repair and Maintenance of Various Office Equipment',
        description: 'Servicing of printers, scanners and the two wide-format plotters.',
        procurement_status_id: 9, pr_type_id: 5, mode_of_procurement_id: 2,
        date: '2026-08-14', date_required: null,
        remarks_unit_head: 'Endorsed. All units are on the approved maintenance plan.',
        remarks_division_fo_head: 'Cleared for Supply review.',
        remarks_supply_officer: 'Preinspection report matches the listed units.',
        remarks_budget_officer: null, remarks_ord: null,
        created_at: '2026-08-14 09:40:00', updated_at: '2026-09-03 11:25:00',
    },
    {
        id: 9, user_id: 8, disbursement_id: 4,
        request_by: 'ARNEL D. MABINI', approved_by: 'ATTY. RICARDO M. ESTRELLA',
        title: 'Catering Services for the Labor Standards Orientation Seminar',
        description: 'Meals and snacks for 120 establishment representatives over two batches.',
        procurement_status_id: 11, pr_type_id: 8, mode_of_procurement_id: 2,
        date: '2026-08-05', date_required: '2026-11-20',
        remarks_unit_head: null, remarks_division_fo_head: null,
        remarks_supply_officer: 'Service request form and activity proposal both on file.',
        remarks_budget_officer: 'Charged against the CY 2026 training allotment.',
        remarks_ord: 'Approved.',
        created_at: '2026-08-05 14:05:00', updated_at: '2026-08-28 09:00:00',
    },
    {
        id: 10, user_id: 8, disbursement_id: 4,
        request_by: 'ARNEL D. MABINI', approved_by: 'ATTY. RICARDO M. ESTRELLA',
        title: 'Printing of Advocacy Materials for the Regional Information Campaign',
        description: 'Handbooks, primers and posters distributed during establishment visits.',
        procurement_status_id: 1, pr_type_id: 3, mode_of_procurement_id: 2,
        date: '2026-09-07', date_required: null,
        remarks_unit_head: null, remarks_division_fo_head: null, remarks_supply_officer: null,
        remarks_budget_officer: null, remarks_ord: null,
        created_at: '2026-09-07 08:50:00', updated_at: '2026-09-09 15:30:00',
    },
]
...
export const lots: Lot[] = [
    ...
    { id: 8, procurement_id: 7, lot_no: 1, created_at: '2026-09-02 10:21:00', updated_at: '2026-09-02 11:05:00' },
    { id: 9, procurement_id: 8, lot_no: 1, created_at: '2026-08-14 09:41:00', updated_at: '2026-08-14 10:30:00' },
    { id: 10, procurement_id: 9, lot_no: 1, created_at: '2026-08-05 14:06:00', updated_at: '2026-08-05 14:40:00' },
    { id: 11, procurement_id: 10, lot_no: 1, created_at: '2026-09-07 08:51:00', updated_at: '2026-09-07 09:25:00' },
]
...
export const prItems: PrItem[] = [
    ...
    {
        id: 11, lot_id: 8, ppmp_project_item_id: 7,
        item_name: 'Managed Network Switch',
        item_description: '* 48-port Gigabit managed switch\n* Rack mountable, with mounting kit\n* Lifetime hardware warranty',
        unit_id: 4, quantity: 6, unit_cost: 34_500, total_unit_cost: 207_000,
        supply_officer_remarks: null, budget_officer_remarks: null,
        created_at: '2026-09-02 10:35:00', updated_at: '2026-09-02 10:35:00',
    },
    {
        id: 12, lot_id: 8, ppmp_project_item_id: 7,
        item_name: 'Wireless Access Point',
        item_description: '* Dual-band ceiling-mounted access point\n* Power over Ethernet, mounting bracket included\n* Central management via the existing controller',
        unit_id: 4, quantity: 14, unit_cost: 12_800, total_unit_cost: 179_200,
        supply_officer_remarks: null, budget_officer_remarks: null,
        created_at: '2026-09-02 10:52:00', updated_at: '2026-09-02 10:52:00',
    },
    {
        id: 13, lot_id: 9, ppmp_project_item_id: 15,
        item_name: 'Printer and Scanner Servicing',
        item_description: '* General cleaning, roller replacement and calibration\n* Covers 22 units across the division',
        unit_id: 4, quantity: 22, unit_cost: 2_400, total_unit_cost: 52_800,
        supply_officer_remarks: 'Unit count confirmed against the inventory list.', budget_officer_remarks: null,
        created_at: '2026-08-14 09:55:00', updated_at: '2026-08-30 10:15:00',
    },
    {
        id: 14, lot_id: 9, ppmp_project_item_id: 15,
        item_name: 'Wide-Format Plotter Overhaul',
        item_description: '* Printhead replacement and full recalibration\n* Includes a six-month service warranty',
        unit_id: 4, quantity: 2, unit_cost: 38_500, total_unit_cost: 77_000,
        supply_officer_remarks: null, budget_officer_remarks: null,
        created_at: '2026-08-14 10:12:00', updated_at: '2026-08-14 10:12:00',
    },
    {
        id: 15, lot_id: 10, ppmp_project_item_id: 17,
        item_name: 'Meals and Snacks Package',
        item_description: '* AM snack, lunch and PM snack\n* Buffet service with function room set-up\n* Two batches, 120 participants each',
        unit_id: 1, quantity: 240, unit_cost: 780, total_unit_cost: 187_200,
        supply_officer_remarks: null, budget_officer_remarks: 'Rate is within the approved ceiling.',
        created_at: '2026-08-05 14:20:00', updated_at: '2026-08-20 11:00:00',
    },
    {
        id: 16, lot_id: 11, ppmp_project_item_id: 18,
        item_name: 'Labor Standards Handbook',
        item_description: '* A5, 64 pages, full colour\n* Perfect bound, 150gsm inner pages',
        unit_id: 2, quantity: 2_000, unit_cost: 68, total_unit_cost: 136_000,
        supply_officer_remarks: null, budget_officer_remarks: null,
        created_at: '2026-09-07 09:05:00', updated_at: '2026-09-07 09:05:00',
    },
    {
        id: 17, lot_id: 11, ppmp_project_item_id: 18,
        item_name: 'Advocacy Poster Set',
        item_description: '* A2, full colour, 200gsm matte\n* Four designs per set',
        unit_id: 5, quantity: 300, unit_cost: 145, total_unit_cost: 43_500,
        supply_officer_remarks: null, budget_officer_remarks: null,
        created_at: '2026-09-07 09:20:00', updated_at: '2026-09-07 09:20:00',
    },
]
...
export const prAttachments: PrAttachment[] = [
    ...
    {
        id: 7, pr_id: 7,
        justification_letter: 'justification-letter-pr-7.pdf',
        approved_ppmp_proposal: 'approved-ppmp-proposal-pr-7.pdf',
        technical_specification: 'technical-specification-pr-7.pdf',
        preinspection_report: null,
        isa_recommendation_letter: 'isa-recommendation-letter-pr-7.pdf',
    },
    {
        id: 8, pr_id: 8,
        justification_letter: 'justification-letter-pr-8.pdf',
        maintenance_plan: 'maintenance-plan-pr-8.pdf',
        preinspection_report: 'preinspection-report-pr-8.pdf',
    },
    {
        id: 9, pr_id: 9,
        justification_letter: 'justification-letter-pr-9.pdf',
        approved_activity_proposal: 'approved-activity-proposal-pr-9.pdf',
        service_request_form: 'service-request-form-pr-9.pdf',
    },
    {
        // Still missing its Item Specification, so this one cannot be submitted
        // yet — the Employee's own copy of the blocked-submission state.
        id: 10, pr_id: 10,
        justification_letter: 'justification-letter-pr-10.pdf',
        approved_ppmp_proposal: 'approved-ppmp-proposal-pr-10.pdf',
